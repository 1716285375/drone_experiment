...
class AirSimEnv(gym.Env):
    ...
    def __init__(self, image_shape):
        ...
        self.s3 = gym.spaces.Box(-100.0, 100.0, shape=(1,))  # 队形期望误差
        self.s4 = gym.spaces.Box(-100.0, 100.0, shape=(1,))  # 队形期望误差
        self.s5 = gym.spaces.Box(-100.0, 100.0, shape=(1,))  # 队形期望误差
        ...
        self.space = [self.s1, self.s2, self.s3, self.s4, self.s5]
